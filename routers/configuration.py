...
from controllers.configuration import index_page, login_page, update_role, update_password, delete_routes, delete_user
...
@configuration.route('/users/<int:user_id>/delete', endpoint='delete_user', methods=['POST'])
@admin_or_key_required
